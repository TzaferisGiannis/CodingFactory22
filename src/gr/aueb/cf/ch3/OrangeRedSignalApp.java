 ...
 * Αν μία δεξαμενή έχει λιγότερο από 1/4 κάυσιμα
 * τότε ανάβει πορτοκαλί σήμα, ενώ αν και οι δύο δεξαμενές έχουν λιγότερο από
 * 1/4 τότε ανάβει κόκκινο σήμα.
...
public class OrangeRedSignalApp {
    public static void main(String[] args) {
        ...
        System.out.println("Please insert if tank1 , tank 2 are less than 1/4");
