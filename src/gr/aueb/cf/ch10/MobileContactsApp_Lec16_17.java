...
public class MobileContactsApp_Lec16_17 {
...
//            System.out.printf("%s\t%s\t%s\n" , contact[0], contact[1], contact[2]);
        ...
        public static void printMenu () {
            ...
            System.out.println("1. Εσαγωγή Επαφής");
        ...
        public static String getFirstname () {
            System.out.println("Εισάγετε όνομε");
        ...
        //να την δω στο βιντεο 2:25
        public static void updateController (String oldPhoneNumber,
                String firstname, String lastname, String newPhoneNumber){
            try {
                //validation
                ...
                // Service call
                insertContactService(firstname.trim(), lastname.trim(), newPhoneNumber.trim());
...
//            e.printStackTrace();
        ...
        public static void insertContactService (String firstname, String lastname, String phoneNumber){
            try {
                if (!(insert(firstname, lastname, phoneNumber))) {
                    throw new IllegalArgumentException("Erron in insert");
                }
        ...
        public static void updateContactService (String oldPhoneNumber, String firstName, String lastname, String
        newPhoneNumber){
            try {
    ...
    /*
    CRUD (create read update delete) Services that are provided to
    Service Layer
     */
...
//        contact[2] = contacts[positionToUpdate][2];
            ...
            public static void log (Exception e, String...message){
                try (PrintStream ps = new PrintStream(new FileOutputStream(path.toFile(), true))) {
                    ps.println(LocalDateTime.now() + "/n" + e.toString());
